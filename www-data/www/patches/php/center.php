...
switch ($_G['GET']['TYPE']) {
    ...
    case 'submit':
        ...
        $name = Cstr(htmlspecialchars(trim(strip_tags($_POST['name'])), ENT_QUOTES), false, false, 1, 25);
...
if ($_G['TEMPUSER']['CID']) {
    $_G['TEMPUSER']['CLANNAME'] = $_G['TABLE']['CLAN']->getData($_G['TEMPUSER']['CID'])['clanname'];
}
if ($_G['TEMPUSER']['MID']) {
    $_G['TEMPUSER']['MATENAME'] = $_G['TABLE']['USER']->getData($_G['TEMPUSER']['MID'])['name'];
}
if ($_G['TEMPUSER']['FID']) {
    $_G['TEMPUSER']['FATHERNAME'] = $_G['TABLE']['USER']->getData($_G['TEMPUSER']['FID'])['name'];
}
